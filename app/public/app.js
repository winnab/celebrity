...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Turn = __webpack_require__(175);
	...
	function increaseScore(state, action) {
	  ...
	  var teamAScore = state.teamAScore;
	  switch (action.type) {
	    case 'increase':
	...
	// Store:
	var store = (0, _redux.createStore)(increaseScore);
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    onIncreaseClick: function onIncreaseClick() {
	      return dispatch(increaseAction({ state: { teamAScore: 0 } }));
	    }
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Turn = _react2['default'].createClass({
	  displayName: 'Turn',
	  propTypes: {
	    clues: _react2['default'].PropTypes.array.isRequired,
	    endTurnURL: _react2['default'].PropTypes.string,
	    secondsRemaining: _react2['default'].PropTypes.string
	  },
	  ...
	  addLastClue: function addLastClue(clues) {
	  ...
	  addClueToCompleted: function addClueToCompleted(clue) {
	  ...
	  skipToNextClue: function skipToNextClue(clue) {
	  ...
	  removeCurrentClueFromRemaining: function removeCurrentClueFromRemaining() {
	  ...
	  getNextClue: function getNextClue() {
	    this.setState({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'div',
	      { className: 'turn' },
	      !turnIsOver ? _react2['default'].createElement(
	        'div',
	        null,
	        ...
	        _react2['default'].createElement(
	          'button',
	          { disabled: turnIsOver, onClick: this.gotIt },
	          'Got it'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { disabled: turnIsOver, onClick: this.skippedIt },
	          'Skip it'
	        ),
	        _react2['default'].createElement(
	          'div',
	      ...
	      turnIsOver && this.state.cluesCompleted.length ? _react2['default'].createElement(
	        'div',
	        { className: 'guessed-clues-review' },
	        _react2['default'].createElement(
	          'h3',
	          null,
	          'Great Job!'
	        ...
	        _react2['default'].createElement(
	          'p',
	          null,
	          'Your team guessed these clues correctly:'
	        ),
	        _react2['default'].createElement(
	          'ul',
	          null,
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('input', { type: 'text', value: this.state.cluesCompleted }),
	          _react2['default'].createElement('input', { id: 'end-turn-form', type: 'submit' })
	        )
	      )
	    );
	  }
